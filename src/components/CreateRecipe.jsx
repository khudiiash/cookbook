...
export default class CreateRecipe extends Component {
  ...
  onChangeIngredients(e) {
    ...
    e.target.getAttribute("keyname");
    for (var i = 0; i < this.state.ingredientInputs.length; i++) {
      if (e.target.getAttribute("keyname").includes(`${i}`)) {
        ...
        <main className="recipe-main">
          ...
          <div className="recipe-main-preparation-wrapper create-preparation-wrapper">
            ...
            <div className="recipe-main-preparation create-preparation">
             ...
             <div className="form-group">
             <input type="submit" value="Create Recipe" className="btn btn-primary create-recipe" />
          </div>
        </form>
      </div>
    );
